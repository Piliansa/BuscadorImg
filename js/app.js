...
function mostrarAlerta(mensaje) {
    ...
    if (!existeAlerta) {
        ...
        alerta.classList.add('bg-red-100', 'border-red-400', 'text-red-700', 'px-4', 'py-4', 'py-3', 'rounded', 'max-w-lg', 'mx-auto', 'mt-6', 'text-center');
...
function buscarImagenes() {
    ...
    const key = '39051868-e0aca19934878e6e456154154';
